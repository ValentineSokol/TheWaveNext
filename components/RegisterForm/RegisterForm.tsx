...
export function RegisterModal({ login = false, onClose, open = true }) {
  ...
  const {
    setValue, handleSubmit, clearErrors, formState: { errors },
  } = formAPI;
          ...
          <div className={styles.fields}>
            ...
            <Trans
              ...
              components={[
                ...
                <Button size="s" onClick={toggleIsLogin} variant="link_dark" />,
              ]}
            />
            {
                showRequestError
                && <ErrorText id={requestErrorId}>{getRequestErrorMessage()}</ErrorText>
            }
          </div>
          <Button
